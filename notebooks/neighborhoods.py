admin_wards = [
    ...
    'Gaztambide', 'Goya', 'Guindalera', 'Hellín', 'Hispanoamérica', 'Horcajo', 'Ibiza', 'Imperial', 'San Andrés',
    'Jerónimos', 'Justicia', 'La Paz', 'Las Águilas', 'Legazpi', 'Lista', 'Los Cármenes', 'Los Rosales', 'Los Jerónimos',
    'Los Ángeles', 'Lucero', 'Marroquina', 'Media Legua', 'Mirasierra', 'Moscardó', 'Niño Jesús', 'Los Berrocales',
    'Nueva España', 'Numancia', 'Opañel', 'Orcasitas', 'Orcasur', 'Pacífico', 'Palacio', 'Palomas', 'Puerta Bonita',
...
district_neighborhoods = {
    ...
    'villaverde': ['San Andrés', 'Villaverde Alto', 'San Cristóbal', 'Butarque', 'Los Rosales', 'Los Ángeles'],
    'villa-de-vallecas': ['Casco Histórico de Vallecas', 'Los Berrocales', 'Santa Eugenia', 'Ensanche de Vallecas'],
